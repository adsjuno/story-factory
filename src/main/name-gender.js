...
const FEMALE = [
  ...
  'June', 'Constance',
  // hero nu (bo sung theo pool v1.8+)
  'Mildred', 'Thelma', 'Elaine', 'Dolores', 'Lucille', 'Maxine', 'Lillian', 'Pauline',
  'Marjorie', 'Esther', 'Bernice', 'Arlene', 'Sylvia', 'Vera', 'Clara', 'Nadine',
  'Janice', 'Sally', 'Annette', 'Darlene',
  // villain nu (con/chau)
  'Brittany', 'Megan', 'Lauren', 'Courtney', 'Whitney', 'Chelsea', 'Tiffany', 'Bethany',
  'Madison', 'Kaylee', 'Sierra', 'Paige', 'Kayla', 'Amber', 'Heather', 'Crystal',
  // villain nu (bo sung theo pool v1.8+)
  'Nicole', 'Rachel', 'Vanessa', 'Erica', 'Monica', 'Alyssa', 'Brooke', 'Natalie',
  'Kelsey', 'Hailey',
];
...
const MALE = [
  ...
  'Colton', 'Dylan', 'Mason',
  // hero nam (bo sung theo pool v1.8+)
  'Kenneth', 'Dennis', 'Gary', 'Bruce', 'Douglas', 'Philip', 'Patrick', 'Jack',
  'Jerry', 'Terry', 'Johnny', 'Bobby', 'Jimmy', 'Louis', 'Victor', 'Martin',
  'Dean', 'Gene', 'Clifford', 'Warren', 'Gordon', 'Harvey', 'Neil', 'Curtis',
  'Calvin', 'Hugh', 'Milton', 'Perry', 'Morris',
  // villain nam (bo sung theo pool v1.8+)
  'Jason', 'Ryan', 'Kyle', 'Justin', 'Eric', 'Scott', 'Adam', 'Nathan', 'Jeremy',
  'Sean', 'Landon', 'Tristan', 'Cole', 'Gavin', 'Wesley', 'Bryce',
];

// Luong tinh -> khong dung cho vai can ro gioi
const UNISEX = ['Ashley', 'Blake', 'Sloane', 'Morgan', 'Bailey',
  'Jordan', 'Cameron', 'Parker', 'Logan', 'Leslie'];
